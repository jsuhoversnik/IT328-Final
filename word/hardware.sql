...
('ram', 'G.Skill DDR4 3200 64GB', 429, 6432, 0),
('cpu', 'Intel Core i3 7100', 110, 5780, 2),
('mobo', 'ASUS EX-B250M-V3', 70, NULL, 2),
('ram', 'Kingston low voltage 4GB DDR4 2400 (KVR24N17S8/4)', 80, NULL, NULL),
('hdd', 'Western Digital Blue 1TB 7200rpm 64MB sata3 (WD10EZEX)', 40, NULL, NULL),
('cpu', 'Inter Core i5 8400', 180, 11628, 3),
('mobo', 'ASUS PRIME B250M-PLUS', 80, NULL, 3),
('ram', 'Corsair 16GB DDR4 2133 (CMV16GX4M1A2133C15)', 100, NULL, NULL),
...
('ram', 'Kingston Fury series DDR4 2400 16G memory', 130, NULL, NULL),
...
('ram', 'American Pirate Ship Avengers LPX DDR4 3000 8GB Memory', 100, NULL, NULL),
...
('ram', 'Kingston DDR4 2133 8G', 60, NULL, NULL),
('ssd', 'Kingston UV400 Series 120G', 40, NULL, NULL),
('hdd', 'WD 1T Mechanical Hard Drive', NULL, NULL, NULL),
('cpu', 'AMD Ryzen 5 2600', 180, 13548, 8),
('mobo', 'ASUS PRIME B450M-A motherboard', 100, NULL, 8),
('ram', 'Kingston hacker god 8g ddr4 2400', 60, NULL, NULL),
...
('cpu', 'Intel Core i7 8700K ', 350, NULL, 9),
('mobo', 'ASUS PRIME Z370-P motherboard', 180, NULL, 8),
('ram', 'Kingston hacker gods Fury series DDR4 2400 16G memory', 240, NULL, NULL),
